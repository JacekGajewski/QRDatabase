...
public class WatchlistFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerView = (RecyclerView) inflater.inflate(R.layout.fragment_watchlist, container, false);

        Query query = mConditionRef.orderByChild("watchlist").equalTo(true);

        FirebaseRecyclerAdapter<Product, WatchlistFragment.myViewHolder> adapter = new FirebaseRecyclerAdapter<Product, WatchlistFragment.myViewHolder>(
                Product.class, R.layout.fragment_card, WatchlistFragment.myViewHolder.class, query) {
            @Override
            protected void populateViewHolder(WatchlistFragment.myViewHolder viewHolder, final Product model, int position) {
